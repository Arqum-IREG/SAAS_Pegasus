"""
Django settings for Time_sheet_Saas project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-DvLY9QSYLmaCfezNlqXVVA5yJf0BCB3ZoE73iW3m")
...
ROOT_URLCONF = "time_sheet_saas.urls"
...
WSGI_APPLICATION = "time_sheet_saas.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="time_sheet_saas"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "time_sheet_saas_language"
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="support@marys-team.com")
...
EMAIL_SUBJECT_PREFIX = "[Time_sheet_Saas] "
...
ASGI_APPLICATION = "time_sheet_saas.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
WAGTAIL_SITE_NAME = "Time_sheet_Saas Content"
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("Time_sheet_Saas"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("Time Sheet Project"),
...
ADMINS = [("Ahmad Malik", "support@marys-team.com")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "time_sheet_saas": {
            "handlers": ["console"],
            "level": env("TIME_SHEET_SAAS_LOG_LEVEL", default="INFO"),
        },
    },
}
